    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">@lang('pricing.add_new')</h5>
                        <div class="card-body">
                            ...
                            <form id="form">
                                ...
                                <input type="hidden" id="route" value="{{route('pricing.store', app()->getLocale())}}">
                                <div class="form-group">
                                    <label for="city_ar" class="col-form-label">@lang('pricing.city_ar')</label>
                                    <input type="text" name="city_ar" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="city_en" class="col-form-label">@lang('pricing.city_en')</label>
                                    <input type="text" name="city_en" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="note_ar" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
